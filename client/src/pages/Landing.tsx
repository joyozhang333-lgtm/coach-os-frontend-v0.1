 ...
 * Landing — Full-screen immersive hero with dot-grid texture
 * Amber gold accent, volumetric lighting, architectural lines
 */
import { motion } from "framer-motion";
import { Link } from "wouter";
import { ArrowRight, MessageCircle, Users, BarChart3, Layers, Sparkles, Shield, Zap } from "lucide-react";

const HERO_BG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663494351292/UiPe44g7XsskFqpdXViubX/hero-v02-dark_67d2f672.png";
const AVATAR_1 = "https://d2xsxph8kpxj0f.cloudfront.net/310519663494351292/UiPe44g7XsskFqpdXViubX/coach-avatar-serenity_d6e7dd08.png";
const AVATAR_2 = "https://d2xsxph8kpxj0f.cloudfront.net/310519663494351292/UiPe44g7XsskFqpdXViubX/coach-avatar-mirror_70c8e3dc.png";
...
const CAPABILITIES = [
  { icon: Sparkles, title: "深度情绪理解", desc: "基于先进的 NLP 模型，精准识别情绪状态和潜在需求" },
  { icon: Shield, title: "隐私安全保障", desc: "端到端加密，所有对话数据仅你可见，绝不用于训练" },
  { icon: Zap, title: "实时成长追踪", desc: "AI 自动分析对话模式，生成个性化的成长洞见报告" },
];
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              href="/app"
              className="text-[13px] px-5 py-1.5 rounded-lg bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity"
            >
              进入平台
            </Link>
          </div>
          <Link
            href="/app"
            className="md:hidden text-[13px] px-4 py-1.5 rounded-lg bg-primary text-primary-foreground font-medium"
          >
            进入
          </Link>
        </div>
      ...
      <section className="relative py-32 lg:py-40 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} className="mb-16">
            <motion.span custom={0} variants={fadeUp} className="text-xs text-primary font-medium tracking-widest uppercase block mb-4">
              Platform
            </motion.span>
      ...
      <section className="py-24 lg:py-32 px-6 lg:px-10 border-t border-border">
        <div className="max-w-[1400px] mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}>
            ...
            <motion.h2 custom={1} variants={fadeUp} className="text-3xl lg:text-4xl font-bold tracking-tight mb-12">
              为什么选择 CoachOS
            </motion.h2>
          </motion.div>
          ...
          >
            {CAPABILITIES.map((cap, i) => (
              <motion.div key={cap.title} custom={i} variants={fadeUp} className="flex gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary/8 flex items-center justify-center shrink-0">
                  <cap.icon size={22} className="text-primary" strokeWidth={1.5} />
                </div>
                <div>
          ...
          >
            <motion.div custom={0} variants={fadeUp}>
              ...
              <h2 className="text-3xl lg:text-4xl font-bold tracking-tight mb-6">
                每位教练，
                <br />
                都是一颗独特的<span className="text-gradient">宝石</span>。
              </h2>
              ...
              <Link
                href="/marketplace"
                className="group inline-flex items-center gap-2 text-sm text-primary hover:underline underline-offset-4"
              >
            ...
            <motion.div custom={1} variants={fadeUp} className="relative">
              <div className="grid grid-cols-2 gap-6">
                <div className="glow-card p-5 flex flex-col items-center">
                  <img src={AVATAR_1} alt="Coach" className="w-full aspect-square object-cover rounded-lg mb-4" />
                ...
                <div className="glow-card p-5 flex flex-col items-center mt-8">
                  <img src={AVATAR_2} alt="Coach" className="w-full aspect-square object-cover rounded-lg mb-4" />
      ...
      <section className="relative py-32 lg:py-44 overflow-hidden">
        ...
        >
          ...
          <motion.div custom={2} variants={fadeUp}>
            <Link
              href="/app"
              className="group inline-flex items-center gap-3 px-10 py-4 rounded-lg bg-primary text-primary-foreground font-semibold text-base hover:opacity-90 transition-all"
            >
              开始你的旅程
