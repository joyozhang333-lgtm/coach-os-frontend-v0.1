...
const COACHES = [
  {
    ...
    nameEn: "Siyu Chen",
    specialty: "情绪调节 · 正念引导",
    desc: "国家二级心理咨询师背景，擅长帮助来访者觉察情绪模式，通过正念引导和认知行为技术找到内心平静。",
  ...
  },
  {
    ...
    nameEn: "Zimo Lin",
    specialty: "自我探索 · 深度觉察",
    desc: "心理学硕士，专注于精神动力学方向。善于引导你看见行为模式背后的信念系统。",
  ...
  },
  {
    ...
    specialty: "亲密关系 · 沟通表达",
    desc: "家庭治疗师背景，专注于依恋理论和沟通模式。陪伴你改善关系中的表达方式。",
  ...
  },
  {
    ...
    nameEn: "Haoran Wang",
    specialty: "职业发展 · 决策支持",
    desc: "组织心理学博士，曾任企业高管教练。帮助你在职业十字路口理清思路。",
  ...
  },
  {
    ...
    nameEn: "Yifan Zhao",
    specialty: "创业指导 · 压力管理",
    desc: "企业教练认证（ICF PCC），专为创业者提供心理支持和决策框架，在高压环境中保持清醒。",
  ...
  },
  {
    ...
    nameEn: "Mengqi Liu",
    specialty: "晨间正念 · 日记引导",
    desc: "正念减压认证师（MBSR），每天清晨陪伴你开启新的一天，通过正念和日记建立内在秩序。",
